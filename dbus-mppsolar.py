    ...
    # data, mode, warnings = raw
        ...
        with self._dbusinverter as i, self._dbusmppt as m: # self._dbusvebus as v, 
            ...
            if self.hasSolarConnected:
                ...
                m['/Yield/User'] = generated.get('total_generated_energy', float(m['/Yield/User']) * 1000) / 1000
                m['/Yield/System'] = generated.get('total_generated_energy', float(m['/Yield/System']) * 1000) / 1000
